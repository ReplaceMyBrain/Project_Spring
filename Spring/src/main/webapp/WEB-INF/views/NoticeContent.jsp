...
<body>
		...
		<script type="text/javascript">
			...
			function checkUpdate(){
				var form = document.NoticeContent
	...
	<article>
    <section>
   <form action="NoUpdate" method="post" name="NoticeContent">
  				 <input type="hidden" value="${NoticeUpdate.N_NUM }" name="N_NUM">
			...
			<table class="table table-bordered" style="margin-left: auto; margin-right: auto; text-align: left;" width=1300 border=0 cellpadding=2>
                ...
                <tr>
                <th>글 제목 </th>
			 <td><input type="text" name="N_TITLE"  placeholder="글 제목" style="margin: 0px; width: 1160px;"  value="${NoticeUpdate.N_TITLE }"></td>
			 </tr>
			 
	   		<tr> 
	     	   <th>내용</th>
                    <td><textarea style="margin: 0px; width: 1160px; height: 386px;" name="N_CONTENT" placeholder="내용을 입력하세요.">${NoticeUpdate.N_CONTENT }</textarea></td>
                </tr>	
                </table>
                <div style="text-align: center;">
